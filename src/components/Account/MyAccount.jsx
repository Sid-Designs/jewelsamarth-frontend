  ...
  return (
    <div className="container mx-auto py-10 px-4 md:px-6">
      <div className="flex flex-col md:flex-row gap-6">
        {/* Sidebar Menu - Hidden on mobile, sticky on tablet/desktop */}
        <div className="hidden md:block md:w-[35%] lg:w-[30%] xl:w-[25%] relative">
          <div className="sticky top-6"> {/* Added sticky positioning with top offset */}
